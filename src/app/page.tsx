    ...
    <div className="mx-auto w-full max-w-5xl px-6 py-16">
      ...
      <section className="mt-10">
        <h4 className="text-base font-semibold">
          “Whereas utopias are the stuff of dreams, dystopias, the stuff of nightmares, ustopias are what we create together when we're wide awake.”
          – Dr. Ruha Benjamin
          <br />
        </h4>
      
        <h4 className="text-base font-semibold">
          Dr. Ruha Benjamin&apos;s TED Talk discusses creating an UStopia—a world where everyone can thrive, especially alongside technological advancements.
          <br />
        </h4>
